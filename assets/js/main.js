...
window.addEventListener("load", function() {
	...
	const form3 = document.getElementById('email-form');
	form.addEventListener("submit", function(e) {
		e.preventDefault();
	  const data = new FormData(form);
	  const action = "https://script.google.com/macros/s/AKfycbw1MAPB-ptm16V4wf1DTfEpk4-hAiwd7vlOhOicpljFBkLkIWxYHpzNSQdHAm9RW9meLA/exec";
	  fetch(action, {
		method: 'POST',
		body: data,
	  })
	...
	form3.addEventListener("submit", function(e) {		
	  ...
	  const action = "https://script.google.com/macros/s/AKfycbxYS7y0-S1AdeNbK5ddgQ7xP4VVdz7PnO8LDfmVV7Nb4A9qVkn_WwvW2nny7Sc-Rsl3/exec";
	  fetch(action, {
		method: 'POST',
		body: data,
	  })
...
setTimeout(() => {
	document.querySelector('#index-grid').classList.add("grid-2")	
}, 10);
